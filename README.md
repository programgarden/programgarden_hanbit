...
**한빛미디어 교재를 집필 중입니다.** 출간되면 아래 채널로 공지하겠습니다 —
미리 들어와 계시면 출간·업데이트 소식을 가장 먼저 받아보실 수 있어요. 많이 참여해주세요!

- 💬 **카카오톡 오픈채팅(단톡방)** — https://open.kakao.com/o/gKVObqUh
- ☕ **네이버 카페** — https://cafe.naver.com/programgarden
